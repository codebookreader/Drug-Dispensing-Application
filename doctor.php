...
<script src="js/bootstrap.js"></script>
    ...
    <body>
        <h1 style="float: left;font-family:'Arial Rounded MT';font-size:28px">Doctor</h1>
...
?>
                ...
                <ul>
                    ...
                    <li><a href="#contact">View Lab Tests</a></li>
                    <li><a href="#about">Display Consulatations</a></li>
                    <li><a href="random.php">View Drugs</a></li>
